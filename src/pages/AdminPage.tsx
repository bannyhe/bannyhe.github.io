  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 pt-24 pb-8">
      ...
      >
        ...
        <div className="backdrop-blur-xl bg-gradient-to-br from-indigo-50/90 via-purple-50/80 to-pink-50/90 dark:from-gray-900/80 dark:via-purple-950/30 dark:to-gray-900/80 border border-purple-200/50 dark:border-purple-700/30 rounded-2xl shadow-2xl pt-16 pb-20 px-6 md:px-12">
